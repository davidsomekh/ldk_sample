// LicensetTest.cpp : Defines the entry point for the application.
//
...
bool loginLicense()
{
    ...
    unsigned char vendor_code[] =
        "mIquiG/O128okER101YRGPcH+VEwwSc3g8hk3oUfNAwKFzBV+Cq4lKCuFwBCcaasMG5niofd6qpSV9LE"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_LICENSETTEST, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_LICENSETTEST));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_LICENSETTEST));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_LICENSETTEST);
